...
HL_FileLogger::HL_FileLogger(const std::string& logFilePath)
{
	...
	std::string applicationFileLocation = "application";
	...
	//open error log File
	std::string errorFileLocation = "error";
	...
	std::string assertFileLocation = "assert";
	...
	std::string systemFileLocation = "system";
	...
	std::string audioFileLocation = "audio";
	...
	std::string videoFileLocation = "video";
	...
	std::string renderFileLocation = "render";
	...
	std::string inputFileLocation = "input";
	...
	std::string testFileLocation = "test";
